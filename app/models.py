...
Fully synced with MySQL database schema
"""
...
class Driver(Base):
    ...
    fcm_tokens = Column(String(512), nullable=True)
    ...
    live_location = relationship("DriverLiveLocation", back_populates="driver", uselist=False)
...
class Vehicle(Base):
    ...
    vehicle_number = Column(String(20), nullable=True, unique=True)
...
class WalletTransaction(Base):
    ...
    payment = relationship("PaymentTransaction", back_populates="wallet_transactions")
...
class VehicleTariffConfig(Base):
    ...
    vehicle_type = Column(String(50), nullable=True)
    one_way_per_km = Column(DECIMAL(10, 2), nullable=True)
    round_trip_per_km = Column(DECIMAL(10, 2), nullable=True)
    driver_allowance = Column(DECIMAL(10, 2), nullable=True)
    one_way_min_km = Column(Integer, nullable=True)
    round_trip_min_km = Column(Integer, nullable=True)
